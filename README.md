...
2. Double click `run_voicevox.bat` to start VoiceVox engine
3. Wait until you see the message "VoiceVox Engine is ready"
4. Keep this window open while using the AI Waifu
